...
import {Cocktail04Interface} from '../interfaces/cocktail04.interface';

@Injectable({
  providedIn: 'root'
})
export class Cocktail02Service {
  public $cocktails: BehaviorSubject<Cocktail04Interface[]> = new BehaviorSubject<Cocktail04Interface[]>(
    [
      {
        name: 'Mojito',
        img:
