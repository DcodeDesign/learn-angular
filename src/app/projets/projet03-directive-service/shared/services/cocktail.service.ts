...
import {Cocktail03Interface} from '../interfaces/cocktail03.interface';

@Injectable({
  providedIn: 'root'
})
export class CocktailService {
  public $cocktails: BehaviorSubject<Cocktail03Interface[]> = new BehaviorSubject<Cocktail03Interface[]>(
    [
      {
        name: 'Mojito',
        img:
  ...
  public $selectedCocktail: BehaviorSubject<Cocktail03Interface> = new BehaviorSubject<Cocktail03Interface>(
